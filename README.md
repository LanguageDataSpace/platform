...
| Platform release     |       DAPS                                     |  Registry backend        | Registry UI  |                  | Installation  scripts   |
| -------------------- | ---------------------------------------------- | ------------------------ |------------- | ---------------- | ----------------------- |
| 1.0.0-beta prod <br> |   Docker Image: languagedataspace/kc-daps:main |                          |              |                  |                         |
| 1.0.0-beta dev <br>  |   Docker Image: languagedataspace/kc-daps:main |                          |              |                  |                         |
