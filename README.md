...
| -------------------- | ---------------------------------------------- | ------------------------ |------------- |  ----------------------------------------------------------------------  | ---------------------------------- |
| 1.0.0-beta <br>  (scheduled for 07/2025)|   Docker Image: languagedataspace/kc-daps:main  |   [0.9.0](https://github.com/LanguageDataSpace/lds_participant_registry/tree/0.9.0)     |      -        |   https://github.com/LanguageDataSpace/DeploymentCentral/tree/0.9.0prod  |  http://ldssetup.ilsp.gr/    | 
