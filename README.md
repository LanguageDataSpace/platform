...
| Platform release  | Metadata model    | LDS - EDC        | LDS - Proxy  | LDS - UI      | LDS - Proxy ElasticSearch  | LDS - EDC - Postgresql    |  In Connector IAM | Installation  scripts        |  Connector UI  URL     |
| ----------------- | ----------------- | ---------------- |------------- | ------------- | -------------------------- | ------------------------- |  ---------------- | ---------------------------- | ---------------------- | 
